    ...
    <!-- <script type="text/javascript" src="<?= base_url() ?>assets/multiselect/docs/js/jquery-2.2.4.min.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>assets/multiselect/docs/js/bootstrap.bundle-4.5.2.min.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>assets/multiselect/docs/js/prettify.min.js"></script>
    ...
    <script src="<?= base_url() ?>assets/js/custom-chart-area.js"></script>
    <script src="<?= base_url() ?>assets/js/custom-chart-pie.js"></script>
