                ...
                <table class="table table-responsive table-striped" style="display: table;"
                    ...
                    <thead>
                        <tr class="bg-info">
                            ...
                            <th width="15%" class="text-white text-center">Username</th>
                            <th width="20%" class="text-white text-center">First Name</th>
                            <th width="20%" class="text-white text-center">User Type</th>
                            <th width="15%" class="text-white text-center">Created Date</th>
                            <th width="20%" class="text-white text-center">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
