                ...
                <table class="table table-responsive table-striped" style="display: table;"
                    ...
                    <thead>
                        <tr class="bg-info">
                            ...
                            <th width="27%" class="text-white text-center">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php 
                                    $status = explode("|", $trx["status"])[0];
                                    $button = explode("|", $trx["status"])[1];
                                ?>
                                <button type="button" class="btn btn-sm btn-<?= $button ?>" disabled><?= $status ?></button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
