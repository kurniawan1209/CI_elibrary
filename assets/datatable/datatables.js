 ...
 *   https://datatables.net/download/#bs4-4.6.0/jq-3.6.0/dt-1.12.1/fc-4.1.0/fh-3.2.4/r-2.3.0
 *
 * Included libraries:
 *   Bootstrap 4 4.6.0, jQuery 3 3.6.0, DataTables 1.12.1, FixedColumns 4.1.0, FixedHeader 3.2.4, Responsive 2.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4-4.6.0/jq-3.6.0/dt-1.12.1/fc-4.1.0/fh-3.2.4/r-2.3.0",
